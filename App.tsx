    ...
    <div className="flex h-screen bg-slate-900 text-slate-100 overflow-hidden">
      ...
      `}>
        ...
        <div className="p-4 border-t border-slate-800">
          ...
          <a href="https://github.com/shukriyan-ahamed/DocuMind-AI-Intelligent-Document-Analysis-Fraud-Detection-System" className="flex items-center gap-2 text-xs text-slate-500 mt-4 hover:text-slate-300 transition-colors justify-center">
